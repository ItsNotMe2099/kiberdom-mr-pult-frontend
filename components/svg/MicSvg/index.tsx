...
export default function MicSvg({ isOn }: Props) {
    ...
    <>
      ...
      >
        <svg ref={onRef} width="115" height="134" viewBox="0 0 115 134" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M31.7002 0.600098H84.2002V86.0001H31.7002V0.600098ZM48.5002 17.4001V69.2001H67.4002V17.4001H48.5002ZM17.0002 100.7V60.1001H0.200195V117.5H50.6002V133.6H67.4002V117.5H115V60.1001H98.2002V100.7H17.0002Z" fill={appContext.isZoom ? colors.zoom : appContext.isTrueConf ? colors.trueconf : ''} />
        </svg>
      </CSSTransition>
      <CSSTransition
        timeout={500}
